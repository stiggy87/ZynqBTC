...
typedef uint8_t u8; // 8-bit byte
typedef  uint32_t u32; // 32-bit word
...
static const u32 H[8] = {0x6a09e667,0xbb67ae85,0x3c6ef372,0xa54ff53a,0x510e527f,0x9b05688c, 0x1f83d9ab,0x5be0cd19};
 ...
 */
void sha256_transform(u32 state[8], u8 data_t[32]);
 ...
 *	- data[64]
 */
void sha256_update(u32 state[8], u8 data[64], u8 init[32]);
